...
<html lang="en">
    <head>
        ...
        {{ HTML::style('js/utilidades/jquery.jqGrid-4.6.0/src/css/ui.jqgrid.css'); }}
        {{ HTML::script('js//jquery-1.11.2.min.js'); }}
        {{ HTML::script('js/jquery-ui/js/jquery-ui-1.9.2.custom.min.js'); }}
        {{ HTML::script('js/utilidades/jquery.jqGrid-4.6.0/js/i18n/grid.locale-en.js'); }}
        {{ HTML::script('js/utilidades/jquery.jqGrid-4.6.0/js/jquery.jqGrid.min.js'); }}
